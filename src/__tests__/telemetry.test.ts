...
describe('TelemetryReporter', () => {
  ...
  describe('record', () => {
    ...
    it('should call feedback hook when provided', async () => {
      ...
      const reporter = new TelemetryReporter(true, undefined, feedbackHook, 'ext-id', '1.0.0');
    ...
    it('should handle telemetry URL errors gracefully', async () => {
      ...
      const reporter = new TelemetryReporter(true, 'https://telemetry.test.com', undefined, 'ext-id', '1.0.0');
